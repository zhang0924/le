...
<div class="ui attached pointing menu">
    <div class="ui container">
        <div class="right menu">
            ...
            <a class="teal active item">修改用户信息</a>
        </div>
    ...
    <div class="ui form">
        ...
        <form action="${pageContext.request.contextPath}/updateUserServlet" method="post">
            ...
            <div class="field">
                ...
                <input type="text"  id="username" name="username" placeholder="请输入用户名" value="${user.username}" readonly="readonly" >
            </div>

            <div class="field">
                <label for="password">密码：</label>
                <input type="text"  id="password" name="password" placeholder="请输入密码" value="${user.password}"  >
            </div>

            <div class="field">
                <label for="email">Email：</label>
                <input type="text"  id="email" name="email" placeholder="请输入邮箱地址"value="${user.email}" >
            </div>
