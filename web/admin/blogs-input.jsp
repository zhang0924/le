...
<div class="ui attached pointing menu">
    <div class="ui container">
        <div class="right menu">
            <a href="${pageContext.request.contextPath}/admin/blogs-input.jsp" class="teal active item">发布</a>
            <a href="${pageContext.request.contextPath}/findBlogsByPageServlet" class=" item">列表</a>
        </div>
...
<div class="m-container m-padded-tb-big">
    <div class="ui container">
        <form action="${pageContext.request.contextPath}/addBlogServlet" method="post" class="ui form">
            ...
            <div class="required field">
                <div class="ui left labeled input">
                    <div class="ui selection  compact teal basic dropdown label">
                        <input type="hidden" value="原创" name="yzf">
                        <i class="dropdown icon"></i>
            ...
            <div class="field">
                <!--<textarea placeholder="博客内容" name="content" style="display: none" th:text="*{content}"></textarea>-->
                <textarea placeholder="摘要" name="zy" ></textarea>
            </div>
